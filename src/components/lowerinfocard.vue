<template>
    <div class="single-member effect-3" v-if="people.identitys==1">
		            	<div class="member-image">
		                	<img src="../assets/uml.png" alt="Member">
		                </div>
		                <div class="member-info">
		                    ...
		                    <div class="social-touch">
                                ...
                                <el-button type="info" icon="el-icon-plus" circle title="设为管理" @click="tobemanager()"></el-button>
...
<style scoped>
.single-member{border-radius: 35px;width: 250px; float: left; margin: 30px 2.5%; background-color: skyblue; text-align: center; position: relative;}

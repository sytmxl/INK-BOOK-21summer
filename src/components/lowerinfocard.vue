    ...
    <div class="single-member effect-3" v-if="people.identitys==1">
		                ...
		                <div class="member-info">
		                    ...
		                    <div class="social-touch">
                                ...
                                <el-button type="info" icon="el-icon-plus" circle title="设为管理"></el-button>
...
<style scoped>
.single-member{border-radius: 35px;width: 280px; float: left; margin: 30px 2.5%; background-color: skyblue; text-align: center; position: relative;}
